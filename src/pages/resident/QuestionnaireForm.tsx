  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const payload = {
        ...
        on_extended_leave: rotationCtx.on_extended_leave || false,
        extended_leave_type: rotationCtx.on_extended_leave ? rotationCtx.extended_leave_type : null,
        extended_leave_end_block: rotationCtx.on_extended_leave && rotationCtx.extended_leave_end_block ? parseInt(rotationCtx.extended_leave_end_block, 10) : null,
