...
const newsItems = [
  ...
  {id:15,cat:'media',title:'Dr. Abdullah Al Alawi Featured on Oman TV — Nabt Jinan Program',date:'March 2026',dateSort:'2026-03',summary:'Dr. Abdullah M. Al Alawi was featured as a guest on the Oman TV program "Nabt Jinan" (نبت جنان) during Ramadan 1447H, highlighting inspiring Omani personalities.',link:'https://www.youtube.com/watch?v=SnowxT9f9r4',youtubeId:'SnowxT9f9r4'},
  {id:16,cat:'media',title:'Dr. Abdullah Al Alawi on Oman TV — Taryaq: AI in Medicine',date:'March 2026',dateSort:'2026-03',summary:'Dr. Al Alawi was featured on Oman TV's health program "Taryaq" (ترياق) to discuss the role of Artificial Intelligence in modern medicine.',link:'https://www.youtube.com/watch?v=9NKD_sPF0x8',youtubeId:'9NKD_sPF0x8'},
  {id:14,cat:'achievement',title:'Dr. Omar Al Taie Wins First Place for Best Scientific Research',date:'December 2025',dateSort:'2025-12',summary:'Dr. Omar Al Taie was awarded First Place for the best scientific research at the 7th Annual Research Forum of the National Heart Center. His study: "Ten-Year Trends in Cardiac Mortality and Sudden Death in Oman (2014–2023)."',link:'https://x.com/OMSB_OM/status/2005151473563557933'},
  {id:13,cat:'achievement',title:'Dr. Marwa Al Sharji Presents at International Conference',date:'December 2025',dateSort:'2025-12',summary:'Dr. Marwa Al Sharji presented a scientific poster at the Emirates International Gastroenterology and Hepatology Conference.',link:'https://x.com/OMSB_OM/status/2005154326424228031'},
  {id:12,cat:'launch',title:'Launch of Medad: Revolutionizing Clinical Documentation with AI',date:'December 2025',dateSort:'2025-12',summary:'The launch of Medad, an AI-powered ambient clinical documentation system designed specifically for Omani healthcare.',link:'https://www.medad.om/',image:'/images/medad_hero.webp'},
  {id:1,cat:'education',title:'Annual Forum for Medical Specialties Highlights Career and Research Pathways',date:'February 2025',dateSort:'2025-02',summary:'The OMSB organized the Annual Forum for Career Guidance and Scientific Research 2025/2026 at the Oman Convention and Exhibition Centre.',link:'https://www.omandaily.om',image:'/images/news-omsb.jpg'},
  ...
  {id:8,cat:'achievement',title:'Dr. Raja Al Farsi Wins National Research Award',date:'December 2023',dateSort:'2023-12',summary:'The UMC congratulated Dr. Raja Al Farsi for winning the National Research Award for her paper on "Delirium in Patients Admitted to the Internal Medicine Department."',link:'https://x.com/UMC_OMAN/status/1731914315454717976',image:'/images/news-umc-raja-award.jpg'},
];
...
export default function News() {
  ...
  const filtered = useMemo(() => {
    let items = activeTab === 'all' ? sorted : sorted.filter(i => i.cat === activeTab);
    if (search) {
  ...
  return (
    <Layout>
      ...
      <section className="section section-muted" style={{padding:'24px 0'}}>
        <div className="container">
          <div className="search-bar">
            ...
            />
            {search && (
              <button onClick={() => setSearch('')} style={{background:'none',border:'none',cursor:'pointer',color:'var(--text-muted)',fontSize:18,padding:'0 8px'}}>×</button>
            )}
          </div>
        </div>
      </section>
      ...
      {/* Pinned Bayan card */}
      {activeTab !== 'achievement' && activeTab !== 'media' && activeTab !== 'education' && !search && (
            ...
            <div className="news-page-main">
              {displayed.length === 0 ? (
                <div className="text-center" style={{padding:'60px 0'}}>
                  ...
                  <button onClick={() => { setSearch(''); setActiveTab('all'); }} className="btn btn-outline" style={{marginTop:16}}>Clear filters</button>
                </div>
              ) : (
                <>
