...
type Mode = 'password' | 'magic' | 'magic-sent' | 'forgot' | 'forgot-sent';
        ...
        {authenticatedButNoStaff ? (
          <div>
            <div style={{background:'#fef3c7',border:'1px solid #fde68a',borderRadius:12,padding:'20px',textAlign:'center',marginBottom:16}}>
              ...
              <div style={{fontSize:13,color:'#92400e',lineHeight:1.6}}>
                Signed in as <strong>{user?.email}</strong> but no staff profile found. Contact the principal investigator.
              </div>
            </div>
          ...
          <form onSubmit={handleForgotPassword}>
            ...
            <input type="email" required value={email} onChange={e => setEmail(e.target.value)}
              placeholder="you@squ.edu.om" style={inputStyle}
