-- ══════════════════════════════════════════════════════════════
-- SEED PART 2: Sections 4-6 and questions Q15-Q24
-- ══════════════════════════════════════════════════════════════
...
VALUES (
  'b1b1b1b1-0004-4000-8000-000000000001',
  'a1b2c3d4-0001-4000-8000-000000000001',
  'Preferred Hotel Concept & Facilities',
  'المفهوم والخدمات الفندقية المفضلة',
...
INSERT INTO survey_sections (id, survey_id, title_en, title_ar, description_en, description_ar, order_num)
VALUES (
  'b1b1b1b1-0005-4000-8000-000000000001',
  'a1b2c3d4-0001-4000-8000-000000000001',
  'Price Sensitivity & Willingness-to-Pay',
  'حساسية الأسعار والاستعداد للدفع',
...
INSERT INTO survey_sections (id, survey_id, title_en, title_ar, description_en, description_ar, order_num)
VALUES (
  'b1b1b1b1-0006-4000-8000-000000000001',
  'a1b2c3d4-0001-4000-8000-000000000001',
  'Public Opinion & Local Impact',
  'الرأي العام والأثر المحلي للمشروع',
...
VALUES
  (
    'c1c1c1c1-0015-4000-8000-000000000001',
  ...
  (
    'c1c1c1c1-0016-4000-8000-000000000001',
    'b1b1b1b1-0003-4000-8000-000000000001',
    'a1b2c3d4-0001-4000-8000-000000000001',
  ...
  (
    'c1c1c1c1-0017-4000-8000-000000000001',
    'b1b1b1b1-0004-4000-8000-000000000001',
    'a1b2c3d4-0001-4000-8000-000000000001',
...
VALUES (
  'c1c1c1c1-0018-4000-8000-000000000001',
  'b1b1b1b1-0004-4000-8000-000000000001',
  'a1b2c3d4-0001-4000-8000-000000000001',
...
VALUES
  (
    'c1c1c1c1-0019-4000-8000-000000000001',
    'b1b1b1b1-0005-4000-8000-000000000001',
    'a1b2c3d4-0001-4000-8000-000000000001',
    ...
    'radio',
    $$["Below OMR 20","OMR 20 – OMR 30","OMR 31 – OMR 40","OMR 41 – OMR 50","Above OMR 50"]$$::jsonb,
    $$["أقل من 20 ريال عُماني","من 20 إلى 30 ريال عُماني","من 31 إلى 40 ريال عُماني","من 41 إلى 50 ريال عُماني","أكثر من 50 ريال عُماني"]$$::jsonb,
    true,
    19
  ),
  (
    'c1c1c1c1-0020-4000-8000-000000000001',
    'b1b1b1b1-0005-4000-8000-000000000001',
    'a1b2c3d4-0001-4000-8000-000000000001',
  ...
  (
    'c1c1c1c1-0021-4000-8000-000000000001',
    'b1b1b1b1-0006-4000-8000-000000000001',
    'a1b2c3d4-0001-4000-8000-000000000001',
    ...
    $$["موافق بشدة","موافق","محايد","غير موافق","غير موافق بشدة"]$$::jsonb,
    true,
    21
  ),
  (
    'c1c1c1c1-0022-4000-8000-000000000001',
    'b1b1b1b1-0006-4000-8000-000000000001',
    'a1b2c3d4-0001-4000-8000-000000000001',
  ...
  (
    'c1c1c1c1-0023-4000-8000-000000000001',
    'b1b1b1b1-0006-4000-8000-000000000001',
    'a1b2c3d4-0001-4000-8000-000000000001',
    'To what extent do you support the idea of converting or integrating existing farms or heritage houses in the Wilayat into heritage/eco-lodges?',
    'إلى أي مدى تدعم فكرة تحويل أو دمج المزارع القائمة أو البيوت الأثرية في الولاية إلى نزل تراثية/بيئية؟',
    'radio',
    $$["Strongly support","Support","Neutral","Prefer building a completely modern hotel","Do not support the idea"]$$::jsonb,
    $$["أدعم بشدة","أدعم","محايد","أفضل بناء فندق حديث بالكامل","لا أدعم الفكرة على الإطلاق"]$$::jsonb,
    true,
    23
  ),
  (
    'c1c1c1c1-0024-4000-8000-000000000001',
    'b1b1b1b1-0006-4000-8000-000000000001',
    'a1b2c3d4-0001-4000-8000-000000000001',
